    ...
    return (
        <div className="fixed top-24 right-4 md:right-8 z-[60] w-full max-w-sm animate-in slide-in-from-right fade-in duration-300">
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg shadow-xl p-5 relative overflow-hidden">
                ...
                <button onClick={onClose} className="absolute top-2 right-2 text-indigo-400 hover:text-indigo-600 transition-colors p-1 rounded-full hover:bg-indigo-100"><X size={18} /></button>
                <div className="pl-3">
    ...
    return (
        <div className="fixed top-24 right-4 md:right-8 z-[60] w-full max-w-sm animate-in slide-in-from-right fade-in duration-300">
            <div className="bg-teal-50 border border-teal-200 rounded-lg shadow-xl p-5 relative overflow-hidden">
                ...
                <button onClick={onClose} className="absolute top-2 right-2 text-teal-600 hover:text-teal-800 transition-colors p-1 rounded-full hover:bg-teal-100"><X size={18} /></button>
                <div className="pl-3">
