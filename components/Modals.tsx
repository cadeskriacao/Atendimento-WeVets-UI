...
import { CartItem, ModalType, Pet, Service } from '../types';
                ...
                <div className="space-y-4 mb-6">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="date" className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="time" className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow" />
                        </div>
                    </div>
                </div>
                <div className="flex gap-3">
                    <button onClick={onClose} className="flex-1 bg-white border border-indigo-300 text-indigo-600 font-bold py-2.5 rounded-md hover:bg-indigo-50 transition-colors">
                        Cancelar
                    </button>
                    <button onClick={handleConfirm} className="flex-1 bg-indigo-600 text-white font-bold py-2.5 rounded-md hover:bg-indigo-700 transition-colors shadow-sm">
    ...
    return (
        <Modal isOpen={true} onClose={onClose} title="Detalhes do orçamento">
            <div className="p-6 pt-2">
                ...
                <div className="space-y-3">
                    <button className="w-full bg-indigo-600 text-white font-bold py-3 rounded-md hover:bg-indigo-700 transition-colors shadow-sm">
                        Enviar orçamento ao tutor
                    </button>
                    <button onClick={onSchedule} className="w-full bg-white border border-indigo-300 text-indigo-600 font-bold py-3 rounded-md hover:bg-indigo-50 transition-colors">
                        Agendar
                    </button>
